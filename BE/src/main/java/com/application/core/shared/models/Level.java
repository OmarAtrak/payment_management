...
public enum Level {
  ...
  DEBUG,
  /**
   * Info - Generally useful information to log (service start/stop, configuration assumptions,
   * etc). Info I want to always have available but usually don't care about under normal
   ...
   * open a required file, missing data, etc.). These errors will force user (administrator, or
   * direct user) intervention. These are usually reserved (in my apps) for incorrect connection
